...
var __vue_staticRenderFns__ = [];
  ...
  /* module identifier */
  const __vue_module_identifier__ = "data-v-4580da6c";
  /* functional template */
...
/* template */
var __vue_render__$1 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.classes.wrapper},[_vm._ssrNode("<label class=\"inline-flex items-center\"><input type=\"checkbox\""+(_vm._ssrAttr("disabled",_vm.disabled))+(_vm._ssrAttr("checked",_vm.value))+(_vm._ssrAttrs(_vm.$attrs))+(_vm._ssrClass(null,_vm.formInputClasses))+"> <span"+(_vm._ssrClass(null,[_vm.classes.label]))+">"+_vm._ssrEscape("\n      "+_vm._s(_vm.label)+"\n    ")+"</span></label> "+((_vm.hasError)?("<p"+(_vm._ssrClass(null,_vm.classes.error))+">"+_vm._ssrEscape(_vm._s(_vm.errorMessage))+"</p>"):"<!---->"))])};
var __vue_staticRenderFns__$1 = [];
  ...
  /* module identifier */
  const __vue_module_identifier__$1 = "data-v-a302177a";
  /* functional template */
...
var __vue_staticRenderFns__$2 = [];
  ...
  /* module identifier */
  const __vue_module_identifier__$2 = "data-v-51b87ee0";
  /* functional template */
...
var __vue_staticRenderFns__$3 = [];
  ...
  /* module identifier */
  const __vue_module_identifier__$3 = "data-v-7d8226d0";
  /* functional template */
...
/* template */
var __vue_render__$4 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.classes.wrapper},[_vm._ssrNode("<label class=\"inline-flex items-center\"><input type=\"radio\""+(_vm._ssrAttr("name",_vm.name))+(_vm._ssrAttr("disabled",_vm.disabled))+(_vm._ssrAttr("value",_vm.value))+(_vm._ssrAttr("checked",_vm.checked))+(_vm._ssrAttrs(_vm.$attrs))+(_vm._ssrClass(null,_vm.formInputClasses))+"> <span"+(_vm._ssrClass(null,_vm.classes.label))+">"+_vm._ssrEscape(_vm._s(_vm.label))+"</span></label> "+((_vm.hasError)?("<p"+(_vm._ssrClass(null,_vm.classes.errorMessage))+">"+_vm._ssrEscape(_vm._s(_vm.errorMessage))+"</p>"):"<!---->"))])};
var __vue_staticRenderFns__$4 = [];
  ...
  /* module identifier */
  const __vue_module_identifier__$4 = "data-v-f469debc";
  /* functional template */
...
var __vue_staticRenderFns__$5 = [];
  ...
  /* module identifier */
  const __vue_module_identifier__$5 = "data-v-367a5979";
  /* functional template */
